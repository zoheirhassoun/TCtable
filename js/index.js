...
var allInput = registerForm.querySelectorAll("IPUT");
...
function registerationData() {
 userData.push  ({
    ...
    profilePic : imgUrl == undefined ? "img/user.png" : imgUrl
 });
 var userString = JSON.stringify(userData);
 localStorage.setItem("userData", userString);
 swal("Good job!", "Registeration Success!", "success");
}
